...
const ShrinkageSummary: React.FC<ShrinkageSummaryProps> = ({ shrinkage }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-sm shadow-md p-6">
      <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Resumen de Mermas</h2>
      <div className="space-y-4">
        <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-sm">
        ...
        <div className="flex justify-between items-center p-4 bg-danger-50 dark:bg-danger-900/10 rounded-sm">
